...
// Update validation
$validation=true;
if(isset($_POST["updatebtn"]) && ($_SERVER["REQUEST_METHOD"] == "POST")){
                ...
                <div class="row">
                    <form action="update.php" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="category_name" value="<?php echo isset($name) ? $name : "";?>" class="form-control" id="exampleFormControlInput1">
